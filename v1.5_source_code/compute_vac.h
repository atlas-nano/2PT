...
private:
   ...
   void make_mols_grps(MODEL *);

   class Memory * memory;
   STAT ***Pvac;   //Pvac[ngrp][vtype][nstep]
   float **atomEng; //atom energy per timestep
   ATOM *vacatom,*tatom;
   CELL vaccell;
   PROPERTY vacprp;
    GROUP vacgrp;
   ...
   double vac_vsfactor; //velocity scaling factor
